...
function Education(){
    return(
        ...
        <div>
            ...
            <h2 class="edu">Welcome to Investar, where you can see your money grow in awesome ways. Stocks and investing may sound like big terms, but donâ€™t be scared! We are here to help.
            </h2>
            ...
            <h2 class="edu">And thatâ€™s all! Time for you to practice!</h2>
            <br></br>
            <hr></hr>
        </div>
    )
