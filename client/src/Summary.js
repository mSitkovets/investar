...
function Summary({ wallet, profit }) {
  return (
    <Container>
      <Row>
        ...
        <Col className="total">
          <p>Your stock portfolio total is <br></br><h1>${Math.round(wallet * 100) / 100}</h1></p>
        </Col>

        <Col className="profit">
          <p>Today you made <br></br><h1>${Math.round(profit * 100) / 100}</h1></p>
        </Col>
        <Col className="rate">
